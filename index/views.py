...
from .models import Category, Subcategory, Product,Cart, Wishlist,Brand, Size
from .serializers import CategorySerializer, SubcategorySerializer, ProductSerializer,CartSerializer, WishlistSerializer,BrandSerializer, SizeSerializer

# Create your views here.

def index(request):
    return HttpResponse("Hello, world. You're at the index of AVM.")
